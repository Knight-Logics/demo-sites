#!/usr/bin/env python3
"""Generate location landing pages from data/service-areas.json."""
...
BASE = ROOT / "about-us" / "locations-we-serve"
...
def page_template(area: dict) -> str:
    name = area["name"]
    ...
    description = (
        ...
        f"services in {name}. Family owned Tampa Bay roofing since 1988."
    )

    return HEAD.format(title=title, description=description) + f"""
  <section class="page-hero">
    <div class="container">
      <h1>Roofing in <span class="accent">{short}</span></h1>
  ...
  <section class="service-intro-section section-pad">
    <div class="container service-intro-grid">
      <div class="service-intro-content">
        <span class="section-eyebrow">Local Roofing Experts</span>
        <h2>Trusted Roofing Services in {name}</h2>
        <p>{blurb} Roof Monsters brings nearly four decades of Florida roofing experience to every project, with clear estimates, quality materials, and crews who know how Gulf Coast weather affects your roof.</p>
        <p>Whether you need a full replacement, leak repair, storm damage response, or a free inspection, our team delivers responsive service backed by a 15-year workmanship warranty and Atlas material protection on qualifying installs.</p>
        ...
        <div class="benefits-list">
          ...
          <div class="benefit-item"><i class="fa-solid fa-check-circle"></i><p><strong>Free Inspections</strong> — No-pressure assessments with honest recommendations for {short} property owners.</p></div>
        </div>
      </div>
      <div class="service-intro-img">
        <img src="/assets/images/gallery/completed-03.webp" alt="Completed roofing project in {short}" />
      </div>
    </div>
  </section>
  ...
  <section class="why-choose-section section-pad">
    <div class="container">
      <div class="section-header">
        ...
        <h2>Why {short} Homeowners <span class="accent">Choose Us</span></h2>
      ...
      <div class="why-choose-grid">
        <div class="why-card">
          ...
          <p>We understand regional building codes, HOA requirements, and the roofing systems that perform best in {name}.</p>
        </div>
        <div class="why-card">
  ...
  <section class="service-cta-section">
    <div class="container service-cta-grid">
      <div class="service-cta-content">
        ...
        <h2>Schedule Your Free Roofing Consultation in <span class="accent">{short}</span></h2>
      ...
      <div class="cta-form-card">
        ...
        <form class="estimate-form">
          ...
          <div class="form-group">
            ...
            <input type="text" name="address" placeholder="{short} address" />
          </div>
          <div class="form-group">
            <label>Message</label>
...
def main() -> None:
    areas = json.loads(DATA.read_text(encoding="utf-8"))
    for area in areas:
        out_dir = BASE / area["slug"]
        out_dir.mkdir(parents=True, exist_ok=True)
        (out_dir / "index.html").write_text(page_template(area), encoding="utf-8")
